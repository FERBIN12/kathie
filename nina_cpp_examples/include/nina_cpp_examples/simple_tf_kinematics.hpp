...
#include <nina_msgs/srv/get_transform.hpp>
#include <memory>
...
private: 
    ...
    bool getTransformCallback(const std::shared_ptr<nina_msgs::srv::GetTransform::Request> req,
                              const std::shared_ptr<nina_msgs::srv::GetTransform::Response> res);

    rclcpp::TimerBase::SharedPtr timer_;
    rclcpp::Service<nina_msgs::srv::GetTransform>::SharedPtr get_transform_srv_;
