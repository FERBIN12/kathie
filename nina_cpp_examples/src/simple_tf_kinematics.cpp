#include "nina_cpp_examples/simple_tf_kinematics.hpp"
      ...
      rotations_counter_(0)
{
  ...
  // Service Server
  get_transform_srv_ = create_service<nina_msgs::srv::GetTransform>("get_transform", std::bind(&SimpleTfKinematics::getTransformCallback, this, _1, _2));
...
bool SimpleTfKinematics::getTransformCallback(const std::shared_ptr<nina_msgs::srv::GetTransform::Request> req,
                                              const std::shared_ptr<nina_msgs::srv::GetTransform::Response> res)
{
